...
class BukuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($kategoriId) {
            $buku = Buku::where('id_kategori', $kategoriId)->get();
        } else {
            $buku = Buku::all(); // Tampilkan semua buku jika tidak ada kategori yang dipilih
        }
    
        // Ambil data kategori untuk dropdown
        $kategoriList = Kategori::all();
    
        return view('anggota.home', compact('buku', 'kategoriList'));
    }
